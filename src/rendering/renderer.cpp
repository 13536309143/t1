...
bool Renderer::initBasicShaders(Resources& res, RenderScene& rscene, const RendererConfig& config)
{
  ...
  res.compileShader(m_basicShaders.fullScreenVertexShader, VK_SHADER_STAGE_VERTEX_BIT, "passes/fullscreen/fullscreen.vert.glsl");
  res.compileShader(m_basicShaders.fullScreenBackgroundFragShader, VK_SHADER_STAGE_FRAGMENT_BIT, "passes/fullscreen/sky_background.frag.glsl");
  res.compileShader(m_basicShaders.fullscreenAtomicRasterFragmentShader, VK_SHADER_STAGE_FRAGMENT_BIT, "passes/fullscreen/atomic_raster_resolve.frag.glsl");
  res.compileShader(m_basicShaders.renderInstanceBboxesMeshShader, VK_SHADER_STAGE_MESH_BIT_NV,"passes/debug/render_instance_bbox.mesh.glsl", &options);
  res.compileShader(m_basicShaders.renderInstanceBboxesFragmentShader, VK_SHADER_STAGE_FRAGMENT_BIT, "passes/debug/render_instance_bbox.frag.glsl");
  res.compileShader(m_basicShaders.renderClusterBboxesMeshShader, VK_SHADER_STAGE_MESH_BIT_NV,"passes/debug/render_cluster_bbox.mesh.glsl", &options);
  res.compileShader(m_basicShaders.renderClusterBboxesFragmentShader, VK_SHADER_STAGE_FRAGMENT_BIT, "passes/debug/render_cluster_bbox.frag.glsl");
