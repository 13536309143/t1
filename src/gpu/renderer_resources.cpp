/*
 * File: src/gpu/renderer_resources.cpp
...
void Resources::init(VkDevice device, VkPhysicalDevice physicalDevice, VkInstance instance, const nvvk::QueueInfo& queue, const nvvk::QueueInfo& queueTransfer)
{
...

  {
    ...
    const std::vector<std::filesystem::path> searchPaths      = {
        ...
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "shared" / "interface"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "shared" / "common"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "passes" / "cluster"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "passes" / "debug"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "passes" / "fullscreen"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "compute" / "streaming"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "compute" / "traversal"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_EXE_TO_SOURCE_DIRECTORY / "shaders" / "compute" / "build"),
        ...
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "shared" / "interface"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "shared" / "common"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "passes" / "cluster"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "passes" / "debug"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "passes" / "fullscreen"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "compute" / "streaming"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "compute" / "traversal"),
        std::filesystem::absolute(exeDirectoryPath / TARGET_NAME "_files" / "shaders" / "compute" / "build"),
...

  {
    ...
    for(uint32_t i = 0; i < NVHizVK::SHADER_COUNT; i++)
    {
      ...
      compileShader(shaderResults[i], VK_SHADER_STAGE_COMPUTE_BIT, "passes/fullscreen/hierarchical_z.comp.glsl", &options);
    }
