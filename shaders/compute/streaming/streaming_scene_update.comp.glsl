/*
 * File: shaders/compute/streaming/streaming_scene_update.comp.glsl
 * Purpose: Compute shader that applies streaming load/unload patches to scene residency data.
 */
#version 460
